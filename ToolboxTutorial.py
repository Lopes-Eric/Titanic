...
# 1. system scripting.
# 
# ## 1-1 Python Syntax compared to other programming languages
# 
...
# ## 1-11-1 Convert from Python to JSON
# 
...
# ### 1- 14-1 Looping Through an Iterator
# 
...
get_ipython().run_cell_magic('timeit', '-n 10', 's = pd.Series(np.random.randint(0,1000,100))\nfor label, value in s.iteritems():\n    s.loc[label]= value+2')
